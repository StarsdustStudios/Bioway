...
import { TourLocationGetData, tourListSchema } from './components/schema'
import { LocationGetData, locationGetSchema } from '../location/components/schema'
...
export default function TourLocationPage({ index, data }: { index: number; data: any }) {
    ...
    <ItemDataProvider>
      ...
      <Main>
        ...
        <div className='-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-x-12 lg:space-y-0'>
          <TourLocationGetDataTable data={userList} columns={getColumns({index})}/>
        </div>
      </Main>
...
function getColumns({ index }: { index: number }): ColumnDef<TourLocationGetData>[] {
...
interface DataTableProps {
  columns: ColumnDef<TourLocationGetData>[]
  data: TourLocationGetData[]
}

function TourLocationGetDataTable({columns, data}: DataTableProps) {
