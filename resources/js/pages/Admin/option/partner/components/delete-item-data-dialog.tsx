...
import { PartnerGetData } from './schema'
...
export function UsersDeleteDialog({ open, onOpenChange, currentRow }: Props) {
  ...
  const handleDelete = () => {
    ...
    if (value.trim() !== currentRow.name) {
      toast({
        title: 'Delete Failed',
        description: 'The entered partner name does not match.',
      });
      return;
    }
    console.log(currentRow.id)
    router.delete(route('product.partners.destroy', currentRow.id), {
      preserveScroll: true,
      onSuccess: () => {
        console.log('Deleted!')
        window.location.replace('/product/partners')
      }
    })    
  }
        ...
        <div className='space-y-4'>
          ...
          <Label className='my-2'>
            ...
            <Input
              ...
              placeholder='Enter Partner Name to confirm deletion.'
            />
          </Label>
